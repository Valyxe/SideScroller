...
/*
 * This class loads in images from a configuration file
 * and stores them according to their image type.
 */
public class ImagesLoader
{
    ...
    */
	 ...
	 */
	{
		...
		if(posn < 0)
		{
			// System.out.println("No " + name + " image at position " + posn +"; return position 0"); 
	 ...
	 */
	{
		...
		// System.out.println("Returning " + name + " image with pair name " + fnmPrefix);  
		return (BufferedImage) imsList.get(posn);
	}
